...
def main(args):
    ...
    diffusion = GaussianDiffusion(
        ...
        polynomial_T_power = args.polynomial_T_power,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--optimizer", type=str, default="awamW")
    parser.add_argument("--T_schedule", type=str, default="normal")
    parser.add_argument("--polynomial_T_power", type=int, default=2)
    parser.add_argument("--lr_warmup_steps", type=int, default=1000)
    parser.add_argument("--adam_beta1", type=float, default=0.9)
    parser.add_argument("--adam_beta2", type=float, default=0.999)
    parser.add_argument("--adam_weight_decay", type=float, default=1e-6) #lambda use this parameter as lion weight decay
